...
const Article = () => {
  ...
  return (
    ...
    <div style={{ backgroundColor: "aliceblue", maxwidth: "1000px", minHeight: "200px"}}>
      <h2>The Statue of Liberty's torch heads to new museum  </h2>

      <p style={{maxHeight: "2px"}}><i>by Kate Farley (<a href={"mailto:kate.farley@nytimes.com)"}>kate.farley@nytimes.com)</a></i></p>
      ...
      <blockquote style={{maxHeight: "2px"}}>Give me your tired, your poor </blockquote>
      <blockquote>Your huddled masses yearning to breathe free.</blockquote>
      ...
      <li>Height of the Statue from her heel to the top of her head is <b>111 feet, 6 inches</b></li>

      <li>The Statue has a <b>35-foot</b> waistline</li>

      <li>Total weight of the Statue of Liberty is <b>225 tons (or 450,000 pounds)</b></li></ul>
    </div>
  )
}
